...
//        if (hasAttribute) {
//            hasAttribute = true;
//            attributes.stream().filter(attr -> attr.getType().getTypeClass() != null).forEach(
//                    attr -> imports.add(attr.getType().getTypeClass().getPackages().toString() + "." + attr.getType().getTypeClass().getCode()));
//        }
